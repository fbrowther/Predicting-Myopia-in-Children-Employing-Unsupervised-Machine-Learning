...
Therefore, Hierarchial Clustering presents itself as a promising model that can be employed (after further refinement) to predict presence or absense of myopia in children. 
